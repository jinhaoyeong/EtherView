            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="p-4 min-w-0">
                  <h3 className="font-semibold">{t('token.holdings')}</h3>
                ...
                <Card className="p-4 min-w-0">
                  <h3 className="font-semibold">{t('token.current_price')}</h3>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      {typeof token.confidence === 'number' && token.confidence > 0 && (
                        <Badge variant="outline" className="text-xs">
                          {Math.round(token.confidence * 100)}% {t('whale.confidence')}
                        </Badge>
                      )}
                    </div>
                  )}
                ...
                <Card className="p-4 min-w-0">
                  <h3 className="font-semibold">{t('token.volume_24h')}</h3>
                  <p className="font-mono text-sm sm:text-base">{formatCurrency(tokenStats?.volume24h || 0)}</p>
                </Card>

                <Card className="p-4 min-w-0">
                  <h3 className="font-semibold">{t('token.holders')}</h3>
              ...
              {tokenStats?.description && (
                <Card className="p-4 min-w-0">
                  <h3 className="font-semibold mb-2">{t('token.about')} {token.name}</h3>
              ...
              {/* External Links */}
              <Card className="p-4 min-w-0">
                <h3 className="font-semibold mb-2">{t('token.links')}</h3>
